class HomeController < ApplicationController
  def index
    @prompt_template = PromptTemplate.find_by(slug: params[:template]) if params[:template].present?

    @prompt_analysis = PromptAnalysis.new(
      shared: true,
      ai_model: @prompt_template&.ai_model.presence || Ai::PromptAnalyzer.default_model,
      web_search: @prompt_template&.web_search_default || false,
