# -*- encoding: utf-8 -*-
# stub: selenium-webdriver 4.44.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rubyzip>.freeze, [">= 1.2.2", "< 4.0"])
  s.add_runtime_dependency(%q<websocket>.freeze, ["~> 1.0"])
  s.add_development_dependency(%q<git>.freeze, ["~> 1.19"])
  ...
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.7"])
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 3.5"])
  s.add_development_dependency(%q<webmock>.freeze, ["~> 3.5"])
  s.add_development_dependency(%q<webrick>.freeze, ["~> 1.7"])
  s.add_development_dependency(%q<yard>.freeze, ["~> 0.9.11", ">= 0.9.36"])
end
